...
#define DMC_TMPLOC __device__
        DMC_TMPLOC f3Pixel() {}
        DMC_TMPLOC f3Pixel(float r_, float g_, float b_) { x = r_; y = g_; z = b_; }
...
#undef DMC_TMPLOC
...
#endif
    {
        ...
        { // Treat ToneMap(G) as an index into the ColorMap.
