...
namespace {
    ...
    void TestFastSine()
    {
        ...
        while (1) {
            ...
            if (relerr < 0.0001f) Hist[0]++;
            else if (relerr < 0.001f) Hist[1]++;
            else if (relerr < 0.01f) Hist[2]++;
            else if (relerr < 0.1f) Hist[3]++;
            else if (relerr < 0.5f) Hist[4]++;
            else Hist[5]++;
    ...
    void TestFastPowOpt()
    {
        ...
        while (1) {
            ...
            if(c0 > (float) 0x7fffffff || c0 == 0.0f)
                continue;
